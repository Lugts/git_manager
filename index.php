<?php
    ...
    $password = '903aa3d70ca5b8f7c924b58c17d5b88a';
    ...
    if(isset($_REQUEST['action'])){
        ...
        switch($_REQUEST['action']){
            ...
            case 'info':
                ...
                $cd  = 'cd /home/webdev/web/'.$_REQUEST['repo'].';';
    ...
    <body>
        ...
        <div id="main_content" >
            ...
            <div id="repo_list">
                <select id="projects" size="10" >
                    ...
                    <option value="<?php echo $git_project; ?>/public_html" ><?php echo $git_projects_texts[$key]; ?></option>
                    <?php } ?>
                </select>
        ...
        <script type="text/javascript" >
            ...
            $('#createRepoBtn').on('click', function(){
                ...
                $.get('index.php', {action: 'create_repo', repo_url: repo_url, repo_name: repo_name}, function(data){
            ...
            $('#projects').on('change', function(){
                ...
                $.get('index.php', {action: 'info',repo: repo}, function(data){
                    ...
                    $('#pull').on('click', function(){
                        ...
                        $.get('index.php', {action: 'pull', repo: repo, branch: $('#remote_branch').val()}, function(data){
                    ...
                    $('#switch').on('click', function(){
                        ...
                        $.get('index.php', {action: 'switch', repo: repo, branch: $('#branch').val()}, function(data){
                    ...
                    $('#fetch').on('click', function(){
                        ...
                        $.get('index.php', {action: 'fetch', repo: repo}, function(data){
			...
			$('#exec_custom_command').on('click', function(){
				...
				$.get('index.php', {action: 'custom_command', repo: repo, command: cmd}, function(data){
